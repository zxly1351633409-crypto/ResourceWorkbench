...
class DeepModelTargetTests(unittest.TestCase):
    ...
    def test_ruin_batch_maps_each_subject_to_existing_deep_category(self) -> None:
        cases = {
            "示例废土批次 Metal Scrap Scan 16K": "M 模型/F 废土/物件",
            "示例废土批次 SCANS Ukraine Floor Vol.1": "M 模型/F 废土/建筑",
            "示例废土批次 SCANS Ukraine Interior Vol.1": "M 模型/F 废土/场景",
            "示例废土批次 SCANS Ukraine Buildings Vol.5": "M 模型/F 废土/建筑",
            "示例废土批次 SCANS Ukraine Cars Vol.3": "M 模型/F 废土/载具/C 车",
            "示例废土批次 SCANS Ukraine Debris Vol.1": "M 模型/F 废土/物件",
            "示例废土批次 SCANS Ukraine Facades Vol.1": "M 模型/F 废土/建筑",
            "示例废土批次 SCANS Ukraine Military Vol.3": "M 模型/F 废土/载具",
            "示例废土批次 SCANS Ukraine Military Props Vol.1": "M 模型/F 废土/物件",
            "示例废土批次 SCANS Ukraine Supermarket Vol.2": "M 模型/F 废土/物件",
        }
